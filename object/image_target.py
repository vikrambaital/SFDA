...
if __name__ == "__main__":
    ...
    for i in range(len(names)):
        ...
        folder = '/root/data/'
        args.s_dset_path = folder + args.dset + '/images/' + names[args.s] + '.txt'
        args.t_dset_path = folder + args.dset + '/images/' + names[args.t] + '.txt'
        args.test_dset_path = folder + args.dset + '/images/' + names[args.t] + '.txt'
